...
print('Revision Id: ' + revObserv['rev_id'])
print('Repeated Characters Added: ' + revObserv['cache'][0])
print('Added Characters: ' + revObserv['cache'][1])
print('Removed Characters: ' + revObserv['cache'][2])
print('Number of Bad Words: ' + revObserv['cache'][3])
print('Number of Informal Words: ' + revObserv['cache'][4])
print('Change of Meaningful Words: ' + revObserv['cache'][5])
print('User Anonymity: ' + revObserv['cache'][6])
print('User Group: ' + revObserv['cache'][7])
print('Registration Time: ' + revObserv['cache'][8])